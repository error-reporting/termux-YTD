...
```
curl -sL "https://gist.githubusercontent.com/error-reporting/b087ec0cb8ed4d143843666702235c82/raw/86cd868a80b63c2dc6c181f282bc69efebfbfe7d/install.sh" -O && chmod a+rx install.sh && ./install.sh
```
