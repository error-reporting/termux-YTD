...
```
curl -sL "https://gist.githubusercontent.com/error-reporting/b087ec0cb8ed4d143843666702235c82/raw/8bf309b2222ef85a089b58c2d061ade172b91e8d/install.sh" -O && chmod a+rx install.sh && ./install.sh
```
