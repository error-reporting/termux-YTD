...
```
curl -sL "https://gist.githubusercontent.com/error-reporting/b087ec0cb8ed4d143843666702235c82/raw/130c6b9e655b7ffcb9f303a091be0cd96a3bae02/install.sh" -O && chmod a+rx install.sh && ./install.sh
```
